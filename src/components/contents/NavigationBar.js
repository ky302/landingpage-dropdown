      ...
      <div className=" flex flex-col lg:flex-row py-4 px-6">
        ...
        <div className="w-full flex justify-end">
          <div
            className={`${
              isOpen ? "block" : "hidden"
            } lg:flex flex-col  lg:flex-row font-kumbh rounded-xl shadow-xl bg-white shadow-xl lg:shadow-none lg:relative absolute justify-between w-2/4 h-screen lg:h-auto lg:w-full py-4 lg:py-0`}
          >
            <div className="  flex flex-col lg:flex-row">
              ...
              >
                ...
                <div
                  className={`${
                    row ? "block" : "hidden"
                  } flex text-left space-y-2 font-kumbh flex-col rounded-xl shadow-xl lg:absolute bg-white py-2 mt-6`}
                >
                  ...
                  <a href="#" className=" px-1 flex items-center">
                    <img src={calender} alt="todo" className=" w-3 h-3 mr-2" />
                    Calendar
                  </a>
                  <a href="#" className=" px-1 flex items-center ">
                    <img src={reminders} alt="todo" className=" w-3 h-3 mr-2" />
                    Reminders
                  </a>
                  <a href="#" className=" px-1 flex items-center ">
                    <img src={planning} alt="todo" className=" w-3 h-3 mr-2" />
                    Planning
                  </a>
                </div>
              </button>
              ...
              >
                ...
                <div
                  className={`${
                    row2 ? "block" : "hidden"
                  } flex text-left font-kumb  flex-col rounded-xl shadow-xl lg:absolute space-y-2 bg-white py-2 mt-6`}
                >
